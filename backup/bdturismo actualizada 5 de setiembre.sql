...
CREATE TABLE `tbmicroempresa` (
  ...
  `responsablemicroempresa` varchar(100) NOT NULL,
...
CREATE TABLE `tbresponsablefamilia` (
  `idresponsablefamilia` int(11) NOT NULL AUTO_INCREMENT,
  `cedularesponsablefamilia` varchar(50) NOT NULL,
  `nombreresponsablefamilia` varchar(50) NOT NULL,
  `primerapellidoresponsablefamilia` varchar(50) NOT NULL,
  `segundoapellidoresponsablefamilia` varchar(50) NOT NULL,
  `telefonoresponsablefamilia` varchar(50) NOT NULL,
  `emailresponsablefamilia` varchar(75) DEFAULT NULL,
  `idfamilia` int(11) NOT NULL,
  PRIMARY KEY (`idresponsablefamilia`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
