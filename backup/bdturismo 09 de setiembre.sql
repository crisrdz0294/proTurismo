...
INSERT INTO `tbactividad` VALUES (1,'Caminata la divertida','Es una caminata divertida',1,1122,'Rio Friodsadas','100 metros','Muchas','de 9 am a 5 pm',1,1),(2,'Papa','Casa',0,11,'dasadsdsa','adsadsasd','dasads','dasasd',1,2);
...
--
-- Table structure for table `tbresponsablefamilia`
--

DROP TABLE IF EXISTS `tbresponsablefamilia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbresponsablefamilia` (
...
--
-- Dumping data for table `tbresponsablefamilia`
--

LOCK TABLES `tbresponsablefamilia` WRITE;
/*!40000 ALTER TABLE `tbresponsablefamilia` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbresponsablefamilia` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbservicioalimentacion` (
  ...
  `precioservicioalimentacion` int(11) NOT NULL,
...
CREATE TABLE `tbserviciohospedaje` (
  ...
  `banosserviciohospedaje` tinyint(1) NOT NULL,
...
INSERT INTO `tbsitioturistico` VALUES (1,'Las palmas','27100220',1,1,1,'De la casa de pablo 100 metros oeste','www.laspalmas.com'),(2,'Laureles','27102222',1,1,1,'dsdsds','dsdsds');
...
INSERT INTO `tbtipoactividad` VALUES (1,'Ganadera','Relacionadas con la ganaderia'),(2,'Agricola','Relacionadas con el campo');
...
-- Dump completed on 2017-09-09 13:52:11
